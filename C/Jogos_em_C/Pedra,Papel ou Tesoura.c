...
#include<locale.h>
//------------------------------------------------------------------------------
void Jogo(){ //Fun��o para executar o Jogo de Pedra,Papel ou Tesoura
...
//Leitura de Op��es Jogador 1 e Jogador 2
printf("Jogador 1: ");
     scanf("%d",&Escolha_J1);
printf("Jogador 2: ");
     scanf("%d",&Escolha_J2);   
...
switch(Escolha_J1){
	...
	case 3:
		...
		break;
    default:
   	    printf(">>Escolha Inv�lida,queira tentar novamente!\n");
}
//Escolha Jogador 2-------------
switch(Escolha_J2){
	case 1:
...
//Compara��o para determinar Vit�ria entre Jogador 1 e Jogador 2
